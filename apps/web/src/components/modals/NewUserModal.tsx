        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="px-4 py-3 border-t border-slate-100 flex justify-end gap-3 shrink-0 bg-slate-50/50">
            <button 
              type="button"
              onClick={onClose}
              className="px-3 py-1.5 text-sm font-medium text-slate-700 hover:bg-slate-200 bg-slate-100 rounded-lg transition-colors"
            >
              Cancelar
            </button>
            <button 
              type="submit"
              disabled={submitting}
              className="px-3 py-1.5 text-sm font-medium text-white bg-brand-green hover:bg-brand-greenHover rounded-lg transition-colors shadow-sm shadow-brand-green/20 disabled:opacity-50"
            >
