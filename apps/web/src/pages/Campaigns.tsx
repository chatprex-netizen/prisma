      ...
      <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-6 h-full flex flex-col">
        ...
        <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center gap-4 shrink-0">
          ...
          <button 
            ...
            className="bg-brand-green hover:bg-brand-greenHover text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center justify-center gap-2 transition-colors shadow-sm shadow-brand-green/20 w-full md:w-auto"
          >
