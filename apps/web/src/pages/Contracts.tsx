        ...
        <div className="overflow-x-auto flex-1 custom-scrollbar">
          <table className="w-full text-left text-[11px] sm:text-sm whitespace-nowrap">
            <thead className="bg-slate-50/80 text-slate-550 font-medium border-b border-slate-200">
              <tr>
                <th className="px-3 py-1.5.5 sm:px-6 sm:py-4">N° Documento / Propiedad</th>
                <th className="px-3 py-1.5.5 sm:px-6 sm:py-4 hidden sm:table-cell">Tipo</th>
                <th className="px-3 py-1.5.5 sm:px-6 sm:py-4 hidden md:table-cell">Comprador</th>
                <th className="px-3 py-1.5.5 sm:px-6 sm:py-4">Monto</th>
            ...
            <tbody className="divide-y divide-slate-100 text-slate-700">
              {loading ? (
                ...
                <tr key={contract.id} className="hover:bg-slate-50/50 transition-colors group">
                  ...
                  <td className="px-3 py-1.5.5 sm:px-6 sm:py-4 hidden md:table-cell">
                  ...
                  <td className="px-3 py-1.5.5 sm:px-6 sm:py-4 text-right relative">
                    <button 
