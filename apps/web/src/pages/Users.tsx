...
export function Users() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-6 min-h-full flex flex-col animate-fade-in text-left">
      {/* Header */}
      ...
      <div className="flex flex-col md:flex-row gap-4 shrink-0">
        <div className="relative flex-1">
          ...
          <input type="text" placeholder="Buscar por nombre o correo electrónico..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)}
                    ...
                    <td className="px-3 py-2.5 sm:px-6 sm:py-4 text-right">
                      <div className="relative inline-block text-left">
                        <button 
                          ...
                          className="p-1 text-slate-400 hover:text-brand-green hover:bg-brand-green/10 rounded-lg transition-colors"
                        >
